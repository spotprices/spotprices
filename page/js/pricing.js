// Electricity tax (Elektrizitätsabgabe) — reduced rate during 2022-04-01 to 2024-12-31
...
function getElektrizitaetsabgabe(date) {
    ...
    if (d >= REDUCED_TAX_START && d <= REDUCED_TAX_END) return 0.1;
    return OEKOSTROMFOERDERBETRAG_ARBEIT + OEKOSTROMFOERDERBETRAG_VERLUST + ELEKTRIZITAETSABGABE;
}
